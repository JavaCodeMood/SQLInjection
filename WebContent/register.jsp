...
<html>  
    ...
    <div class="container">  
        <div class="form row">  
            <form class="form-horizontal col-sm-offset-3 col-md-offset-3" action="register.do" method="post">  
                ...
                <div class="col-sm-9 col-md-9">  
                    ...
                    <div class="form-group">  
                       <input class="form-control required" type="text" placeholder="年龄" name="age" autofocus="autofocus"/>  
                    </div>  
                    <div class="form-group">  
